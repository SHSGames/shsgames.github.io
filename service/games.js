module.exports = {
	groups: [{
		...
		},
		{
			name: "B-Cubed",
			engine: "flash",
			params: { aspectRatio: 10/9, options: {} }
		},
		{
		...
		},
		{
			name: "Bloxorz",
			engine: "flash",
			params: { aspectRatio: 16/9, options: {} }
		},
		{
			name: "BMX Park",
			engine: "flash",
		...
		},
		{
			name: "Super Mario 63",
			engine: "flash",
			params: { aspectRatio: 800/(533 + 1/3), options: {} }
		},
		{
			name: "Super Mario Crossover",
			engine: "flash",
			params: { aspectRatio: 510/478, width: 510, options: {} }
		},
		{
