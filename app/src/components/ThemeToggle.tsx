...
export default function ThemeToggle(): JSX.Element {
	...
	return (
		<div onClick={ nextState } className="relative md:w-auto w-12 h-12 my-0 m-2 md:my-2 rounded-full md:h-8 py-1 px-4 text-2xl inline-flex items-center font-semibold cursor-pointer bg-zinc-800/60 hover:bg-zinc-700/60 text-white justify-center ml-auto z-[3] border-[1px] border-neutral-700/60 backdrop-blur-lg">
