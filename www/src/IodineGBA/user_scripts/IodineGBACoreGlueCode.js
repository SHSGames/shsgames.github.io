...
function downloadROM(gamename) {
    Iodine.pause();
    downloadFile(`https://raw.githubusercontent.com/JoshMerlino/shsg-pfile/master/games/${window.parent.app.slug(window.parent.app.game.name)}.gba?${Date.now()}`, registerROM, true);
}
