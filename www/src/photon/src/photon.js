;(function(){$.fn.realwidth=function(){return this.width()+parseInt(this.css("padding-left"))+parseInt(this.css("padding-right"))};$.fn.realheight=function(){return this.height()+parseInt(this.css("padding-top"))+parseInt(this.css("padding-bottom"))}; $.fn.textWidth = function() {var o = $(this).html(); var g = '<span>' + o + '</span>'; $(this).html(g); var width = $(this).find('span:first').width(); $(this).html(o); return width}; $.fn.retab=function(){var i=0;this.each(function(){$(this).attr("tabindex","0");i++})};$.nest=function(nest){var n=nest.split(" ");var s=$(n[0]);n.shift();$.each(n,function(i){s=s.children(n[i])});return s}}());
!function(t){var e=function(){"use strict";var e=e||{},n=document.querySelectorAll.bind(document),o=Object.prototype.toString,a="ontouchstart"in t;function i(t){var e=typeof t;return"function"===e||"object"===e&&!!t}function r(t){var e,a=o.call(t);return"[object String]"===a?n(t):i(t)&&/^\[object (Array|HTMLCollection|NodeList|Object)\]$/.test(a)&&t.hasOwnProperty("length")?t:i(e=t)&&e.nodeType>0?[t]:[]}function s(t){var e,n,o={top:0,left:0},a=t&&t.ownerDocument;return e=a.documentElement,void 0!==t.getBoundingClientRect&&(o=t.getBoundingClientRect()),n=function(t){return null!==(e=t)&&e===e.window?t:9===t.nodeType&&t.defaultView;var e}(a),{top:o.top+n.pageYOffset-e.clientTop,left:o.left+n.pageXOffset-e.clientLeft}}function u(t){var e="";for(var n in t)t.hasOwnProperty(n)&&(e+=n+":"+t[n]+";");return e}var c={duration:5*$(this).width,delay:2e3,show:function(t,e,n){if(2===t.button)return!1;e=e||this;var o=document.createElement("div");o.className="waves-ripple waves-rippling",e.appendChild(o);var a=s(e),i=0,r=0;"touches"in t&&t.touches.length?(i=t.touches[0].pageY-a.top,r=t.touches[0].pageX-a.left):(i=t.pageY-a.top,r=t.pageX-a.left),r=r>=0?r:0,i=i>=0?i:0;var l="scale("+Photon.Waves.calc(e,r,i)+")",d="translate(0,0)";n&&(d="translate("+n.x+"px, "+n.y+"px)"),o.setAttribute("data-hold",Date.now()),o.setAttribute("data-x",r),o.setAttribute("data-y",i),o.setAttribute("data-scale",l),o.setAttribute("data-translate",d);var f={top:i+"px",left:r+"px"};o.classList.add("waves-notransition"),o.setAttribute("style",u(f)),o.classList.remove("waves-notransition"),f["-webkit-transform"]=l+" "+d,f["-moz-transform"]=l+" "+d,f["-ms-transform"]=l+" "+d,f["-o-transform"]=l+" "+d,f.transform=l+" "+d;var v="mousemove"===t.type?750:c.duration;f["-webkit-transition-duration"]=v+"ms",f["-moz-transition-duration"]=v+"ms",f["-o-transition-duration"]=v+"ms",f["transition-duration"]=v+"ms",o.setAttribute("style",u(f))},hide:function(t,e){for(var n=(e=e||this).getElementsByClassName("waves-rippling"),o=0,i=n.length;o<i;o++)d(t,e,n[o]);a&&(e.removeEventListener("touchend",c.hide),e.removeEventListener("touchcancel",c.hide)),e.removeEventListener("mouseup",c.hide),e.removeEventListener("mouseleave",c.hide)}},l={input:function(e){var n=e.parentNode;if("i"!==n.tagName.toLowerCase()||!n.classList.contains("waves-effect")){var o=document.createElement("i");o.className=e.className+" waves-input-wrapper",e.className="waves-button-input",n.replaceChild(o,e),o.appendChild(e);var a=t.getComputedStyle(e,null),i=a.color,r=a.backgroundColor;o.setAttribute("style","color:"+i+";background:"+r),e.setAttribute("style","background-color:rgba(0,0,0,0);")}},img:function(t){var e=t.parentNode;if("i"!==e.tagName.toLowerCase()||!e.classList.contains("waves-effect")){var n=document.createElement("i");e.replaceChild(n,t),n.appendChild(t)}}};function d(t,e,n){if(n){n.classList.remove("waves-rippling");var o=n.getAttribute("data-x"),a=n.getAttribute("data-y"),i=n.getAttribute("data-scale"),r=n.getAttribute("data-translate"),s=(Date.now(),Number(n.getAttribute("data-hold")),0);"mousemove"===t.type&&(s=150);var c="mousemove"===t.type?750:1250;setTimeout(function(){var t={top:a+"px",left:o+"px",opacity:"0","-webkit-transition-duration":c+"ms","-moz-transition-duration":c+"ms","-o-transition-duration":c+"ms","transition-duration":c+"ms","-webkit-transform":i+" "+r,"-moz-transform":i+" "+r,"-ms-transform":i+" "+r,"-o-transform":i+" "+r,transform:i+" "+r};n.setAttribute("style",u(t)),setTimeout(function(){try{e.removeChild(n)}catch(t){return!1}},c)},s)}}var f={touches:0,allowEvent:function(t){var e=!0;return/^(mousedown|mousemove)$/.test(t.type)&&f.touches&&(e=!1),e},registerEvent:function(t){var e=t.type;"touchstart"===e?f.touches+=1:/^(touchend|touchcancel)$/.test(e)&&setTimeout(function(){f.touches&&(f.touches-=1)},500)}};function v(t){var e=function(t){if(!1===f.allowEvent(t))return null;for(var e=null,n=t.target||t.srcElement;n.parentElement;){if(!(n instanceof SVGElement)&&n.classList.contains("waves-effect")){e=n;break}n=n.parentElement}return e}(t);if(null!==e){if(e.disabled||e.getAttribute("disabled")||e.classList.contains("disabled"))return;if(f.registerEvent(t),"touchstart"===t.type&&c.delay){var n=!1,o=setTimeout(function(){o=null,c.show(t,e)},c.delay),i=function(a){o&&(clearTimeout(o),o=null,c.show(t,e)),n||(n=!0,c.hide(a,e)),s()},r=function(t){o&&(clearTimeout(o),o=null),i(t),s()};e.addEventListener("touchmove",r,!1),e.addEventListener("touchend",i,!1),e.addEventListener("touchcancel",i,!1);var s=function(){e.removeEventListener("touchmove",r),e.removeEventListener("touchend",i),e.removeEventListener("touchcancel",i)}}else c.show(t,e),a&&(e.addEventListener("touchend",c.hide,!1),e.addEventListener("touchcancel",c.hide,!1)),e.addEventListener("mouseup",c.hide,!1),e.addEventListener("mouseleave",c.hide,!1)}}return e.init=function(t){var e=document.body;"duration"in(t=t||{})&&(c.duration=t.duration),"delay"in t&&(c.delay=t.delay),a&&(e.addEventListener("touchstart",v,!1),e.addEventListener("touchcancel",f.registerEvent,!1),e.addEventListener("touchend",f.registerEvent,!1)),e.addEventListener("mousedown",v,!1)},e.attach=function(t,e){var n,a;t=r(t),"[object Array]"===o.call(e)&&(e=e.join(" ")),e=e?" "+e:"";for(var i=0,s=t.length;i<s;i++)a=(n=t[i]).tagName.toLowerCase(),-1!==["input","img"].indexOf(a)&&(l[a](n),n=n.parentElement),-1===n.className.indexOf("waves-effect")&&(n.className+=" waves-effect"+e)},e.ripple=function(t,e){var n=(t=r(t)).length;if((e=e||{}).wait=e.wait||0,e.position=e.position||null,n)for(var o,a,i,u={},l=0,d={type:"mousedown",button:1},f=function(t,e){return function(){c.hide(t,e)}};l<n;l++)if(o=t[l],a=e.position||{x:o.clientWidth/2,y:o.clientHeight/2},i=s(o),u.x=i.left+a.x,u.y=i.top+a.y,d.pageX=u.x,d.pageY=u.y,c.show(d,o),e.wait>=0&&null!==e.wait){setTimeout(f({type:"mouseup",button:1},o),e.wait)}},e.calm=function(t){for(var e={type:"mouseup",button:1},n=0,o=(t=r(t)).length;n<o;n++)c.hide(e,t[n])},e.displayEffect=function(t){e.init(t)},e};$(function(){$(".waves-effect").on("touchstart",function(t){var e=t.targetTouches[0].pageX-$(this).offset().left,n=t.targetTouches[0].pageY-$(this).offset().top;Waves.ripple(this,{wait:1e10,position:$(this).hasClass("waves-ink")?null:{x:e,y:n}})}).on("touchend",function(t){Waves.calm(this)})}),"function"==typeof define&&define.amd?define([],function(){return t.Waves=e.call(t),t.Waves}):"object"==typeof exports?module.exports=e.call(t):t.Waves=e.call(t)}(window);
