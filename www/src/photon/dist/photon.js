...
!function (t) {
  var e = function () {
    ...
    var c = {
      ...
      hide: function (t, e) {
        for (var n = (e = e || this).getElementsByClassName("waves-rippling"), o = 0, i = n.length; o < i; o++) d(t, e, n[o]);
    ...
    return e.init = function (t) {
      ...
      for (var i = 0, s = t.length; i < s; i++) a = (n = t[i]).tagName.toLowerCase(), -1 !== ["input", "img"].indexOf(a) && (l[a](n), n = n.parentElement), -1 === n.className.indexOf("waves-effect") && (n.className += " waves-effect" + e);
      ...
      for (var e = {
        type: "mouseup",
        button: 1
      }, n = 0, o = (t = r(t)).length; n < o; n++) c.hide(e, t[n]);
      ...
      init: function (options) {
        ...
        return this.each(function (i) {
          ...
          $this.off('click.tabs').on('click.tabs', 'a', function (e) {
            ...
            let $oldContent = $content; // Update the variables with the new link and content
            ...
            $links = $this.find('li.tab a');
            let activeRect = $active.position(); // Make the tab active.
    ...
    return new class Toast {
      constructor(args) {
        ...
        $(document.body).on("mouseup", function () {
          ...
          if (e.which === 37) {
            aftoast.css({
              "transform": `translateX(-${aftoast.width() / 2}px)`
            });
          } else if (e.which === 39) {
            aftoast.css({
              "transform": `translateX(${aftoast.width() / 2}px)`
